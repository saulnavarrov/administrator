...
module.exports = {
  ...
  **************************************************************************/
  datastores: {
    ...
    ***************************************************************************/
    default: {
      adapter: l.db.development.adapter,
      url: `mongodb://${l.db.development.user}:${l.db.development.pass}@${l.db.development.url}:${l.db.development.port}/${l.db.development.db}`,
  ...
  ***************************************************************************/
  session: {
    ...
    *                                                                          *
    ***************************************************************************/
    adapter: l.connect.development.connect,
    url: `mongodb://${l.connect.development.user}:${l.connect.development.pass}@${l.connect.development.url}:${l.connect.development.port}/${l.connect.development.db}`,
