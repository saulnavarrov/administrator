parasails.registerPage('contacto', {
  ...
  methods: {
    ...
    sendMessageContact: async function () {
      ...
      let urls = '/api/v2/deliver-contact-form-message';
      let send = false;
      ...
      if (send) {
        ...
        await io.socket.request({
          ...
          if (jwRes.statusCode === 200) {
            swal('Mensaje enviado', 'El mensaje se envio con exito. En breve estaremos respondiendo a tu mensaje o te estaremos llamando para darte mucha mas información.', 'success');
