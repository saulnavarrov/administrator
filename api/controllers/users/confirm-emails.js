 ...
 *
 * @src {{proyect}}/api/controllers/users/confirm-emails.js
...
module.exports = {
  ...
  friendlyName: 'Confirm emails',


  description: 'Confirmación del correo electronico de nuevos usuario creados',

  extendedDescription: `Confirmar la dirección de correo electrónico de un nuevo usuario, o la solicitud de un usuario
  ...
  exits: {
    ...
    redirectUser: {
      responseType: 'redirect',
      description: `Se redireccióna debido a que hay un usuario con la cuenta de el abierta, se lanza al "Logout"
      para cerrar la sesión y protegar el usuario que dejo abierta.`
    },
  ...
  fn: async function (inputs, exits) {
    ...
    // ==================================
      ...
      if (await Users.count({ emailAddress: user.emailChangeCandidate }) > 0) {
